...
export default function Curriculum() {
     return (
          <a href='https://www.linkedin.com/in/agustin-digiacinto/overlay/1635502083443/single-media-viewer/?profileId=ACoAADbea4gBRvhAlPrYNncXsqiaLFPTOHRhEm8' target='_Blank' className='Curriculum clickeable'>
